  ...
  >
    <div class="container px-4 mx-auto" v-if="dataReady">
      ...
      <div class="md:max-w-3xl mx-auto">
        <p
          class="mb-8 pb-10 text-lg md:text-xl font-medium text-coolGray-500 border-b border-coolGray-100"
...
export default {
  ...
  methods: {
    getNote() {
      ...
      const noteRef = db.collection("notes").doc(this.$route.params.id);
      noteRef
        .get()
        .then((doc) => {
          if (doc.exists) {
