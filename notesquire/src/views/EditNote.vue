        ...
        <div class="xl:ml-80">
            <section class="bg-white py-4">
                <div class="container px-4 mx-auto">
                    <div>
                        <div class="p-6 pb-0 h-full overflow-hidden bg-white rounded-t-md" v-if="dataReady">
                            <div class="pb-6 border-b border-coolGray-100">
                                <div class="flex flex-wrap items-center justify-between -m-2">
                                    <div class="w-full p-2">
                                        <h2 class="text-coolGray-900 text-lg font-semibold">New Note</h2>
                                        <p class="text-xs text-coolGray-500 font-medium">Create a new note to share with
                                            the world, or not.
                                        </p>
                                    </div>
                                </div>
                                        ...
                                        <div class="w-full md:flex-1 p-3">
                                            <div class="flex flex-wrap -m-3">
                                                <div class="w-full p-3 md:w-2/3">
                                                    <p class="mb-1.5 font-medium text-base text-coolGray-800">Note Title
                                                    </p>
                                                    <input
                                                ...
                                                <div class="w-full p-3 md:w-1/3">
                                                    <p class="mb-1.5 font-medium text-base text-coolGray-800">Note
                                                        Privacy</p>
                                                    <div class="relative">
                                                        <select
                                                ...
                                                <div class="w-full md:flex-1 p-3">
                                                    <p class="mb-1.5 font-medium text-base text-coolGray-800">Note Url
                                                    </p>
                                                    <div
                                                        ...
                                                        <input
                                                            ...
                                                            type="text" placeholder="my-awesome-note"
                                                            @input="replaceSpecialCharacter" v-model="url" />
                                                    </div>
                                                </div>
                                                <div class="w-full p-3">
                                                    ...
                                                    <input
                                                        class="w-full px-4 py-2.5 text-base text-coolGray-900 font-normal outline-none focus:border-green-500 border border-coolGray-200 rounded-lg shadow-input"
                                                        type="text" placeholder="Quick note description."
                                                        v-model="description">
                                                </div>

                                                <div class="w-full p-3">
                                                    <p class="mb-1.5 font-medium text-base text-coolGray-800">Content
                                                    </p>
                                                    <textarea
                                                        ...
                                                        rows="10" placeholder="Your note content..."
                                                        v-model="content" />
                                                </div>
                                            </div>
                                        </div>
            ...
            firebase
                ...
                .then((doc) => {
                    if (doc.exists) {
                        ...
                        this.date = doc.data().createdOn;
                        this.url = doc.data().url;
                        this.oldUrl = doc.data().url;
