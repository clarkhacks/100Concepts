...
(function() {
	...
	// "On Visible" animations.
		onvisible.add('.image.style1', { style: 'fade-in', speed: 1750, intensity: 5, delay: 0, replay: false });
		onvisible.add('#text01', { style: 'zoom-in', speed: 1000, intensity: 5, delay: 0, replay: false });
		onvisible.add('#video01', { style: 'fade-in', speed: 1000, intensity: 5, delay: 0, replay: false });
